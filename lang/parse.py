    ...
    def _unroll(tree,variable):
        ...
        if variable in tree and tree[variable] != None:
            ...
            while sub != None:
                ...
                unrolled.append(Util._unroll(sub,variable))
                sub = tmp
        return dict([(name,Util._unroll(tree[name],variable)) for name in tree])
